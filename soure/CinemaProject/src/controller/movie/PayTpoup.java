...
public class PayTpoup extends JFrame {
	...
	public PayTpoup() {
		...
		五百.setIcon(new ImageIcon(PayTpoup.class.getResource("/picture/加500.png")));
		...
		一千.setIcon(new ImageIcon(PayTpoup.class.getResource("/picture/加1000.png")));
		...
		三千.setIcon(new ImageIcon(PayTpoup.class.getResource("/picture/加3000.png")));
		...
		一百.setIcon(new ImageIcon(PayTpoup.class.getResource("/picture/加100.png")));
		...
		兩千.setIcon(new ImageIcon(PayTpoup.class.getResource("/picture/加2000.png")));
		...
		三百.setIcon(new ImageIcon(PayTpoup.class.getResource("/picture/加300.png")));
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Member m4=(Member) Cal.ReadObject("Member.txt");
				Integer cashtopup =m4.getCash();
				MoviePay.setMembercashShow(cashtopup);			
				dispose();
			}
			@Override
		...
		btnNewButton_1.setBounds(295, 13, 100, 30);
		...
		lblNewLabel.setIcon(new ImageIcon(PayTpoup.class.getResource("/picture/小儲值頁.png")));
